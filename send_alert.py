...
Requires your WhatsApp number to have joined the Twilio sandbox first (see
whatsapp_config.py) -- without that one-time opt-in, Twilio will silently
fail to deliver and send_whatsapp_message() will raise/return False.
"""
...
if __name__ == "__main__":
    send_alert("MODI1 alert fallback test: Telegram -> WhatsApp wiring works!")
